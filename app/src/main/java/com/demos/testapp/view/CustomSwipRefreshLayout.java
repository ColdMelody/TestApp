...
/**
 * Created by Bill on 2017/1/12.
 * Email androidBaoCP@163.com
 */

public class CustomSwipRefreshLayout extends SwipeRefreshLayout{
    ...
    public CustomSwipRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
